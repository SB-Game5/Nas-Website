<div class="text-sm text-gray-300 space-y-4">
    <form action="{{ route('logout') }}" method="POST" class="inline">
        ...
        <button type="submit" class="px-4 py-2 text-sm font-medium text-white bg-red-600 rounded-lg hover:bg-red-700 transition focus:ring-4 focus:ring-red-900 focus:outline-none">
